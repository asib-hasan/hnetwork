      ...
      {isOpen && (
        <div className="mb-2.5 w-72 rounded-xl p-4 bg-white border border-slate-200 shadow-xl space-y-3">
          ...
          <div className="space-y-2">
            <a
              href="https://wa.me/8801886950505?text=আসসালামু%20আলাইকুম%20Homeo%20Network,%20আমি%20একজন%20হোমিওপ্যাথিক%20চিকিৎসক।%20আমার%20চেম্বার%20ডিজিটালাইজেশন%20ও%20রোগী%20বৃদ্ধি%20সম্পর্কে%20পরামর্শ%20নিতে%20চাই।"
              target="_blank"
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] text-slate-500 font-normal">+৮৮০ ১৮৮৬-৯৫০৫০৫</span>
              </div>
            </a>
